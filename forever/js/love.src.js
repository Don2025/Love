...
$(function(){
	...
	with(document) 0[(getElementsByTagName('head')[0] || body).appendChild(createElement('script')).src = 'https://tanyaodan.com/love/forever/js/share.js?cdnversion=' + ~ ( - new Date() / 36e5)];
})